...
const Navbar = ({ title }: any) => {
  ...
  return (
    <div className="z-10 text-3xl text-purple-500 text-center rounded-sm border-2 border-solid border-green-500  flex items-center justify-between px-2">
      ...
      {/* lg-navbar-controls */}
      <div className="hidden md:flex flex-row justify-between w-2/5 lg:w-1/5 max-md:w-full items-center space-x-1 px-1 py-0.5 rounded-lg">
        ...
        <Link href="/auth/signin">
          ...
          >
            ...
            <RiLoginBoxLine className="inline-block text-green-500" size={15} />
          </button>
        </Link>
        <Image
            ...
            {isLoggedIn ? (
              <>
                <Link href="/user/userprofile">
                  ...
                  >
                    <span className="text-lg text-green-500">mayank</span>
